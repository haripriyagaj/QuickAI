...
import { Sparkles, Image as ImageIcon, Hash } from 'lucide-react'
      ...
      >
          ...
          {ImageStyle.map((item) => (
            <span
              ...
              className={`text-xs px-4 py-1 border rounded-full cursor-pointer ${
                selectedStyle === item
                  ? 'bg-green-50 text-purple-700 border-purple-700'
        ...
        <div className="my-6 flex items-center gap-2">
          <label className="cursor-pointer relative inline-flex items-center">
            ...
            />
            <div className="w-9 h-5 bg-slate-300 rounded-full peer-checked:bg-green-500 transition relative">
